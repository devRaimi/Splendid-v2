									...
									>
										...
										<div className='p-4 w-full'>
											...
											>
												...
												<button
													onClick={() => openEdit(p)}
													className='p-2 absolute top-3 right-3 z-99! flex items-center justify-center rounded-lg border border-paper-border hover:border-paper-muted hover:bg-white/60 text-gray-500 hover:text-ink transition text-sm duration-500'
												>
												...
												<button
													...
													className='p-2 absolute top-3 left-3 z-99! flex items-center justify-center rounded-lg border border-red-500 hover:bg-red-500 text-gray-500 transition duration-500 text-[13px]'
												>
													{deleting === p.id ? (
														'…'
													) : (
