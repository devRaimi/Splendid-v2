    ...
    <div className="min-h-dvh bg-night flex flex-col items-center justify-center px-6">
      ...
      <div className="relative w-full max-w-sm">
        <div className="mb-10 text-center">
          <div className="inline-flex w-12 h-12 bg-puff rounded-xl items-center justify-center text-white font-display font-bold text-lg mb-4">SP</div>
          <h1 className="font-display font-bold text-white text-[26px]">Staff access</h1>
          <p className="text-white/40 text-[13px] mt-1">Enter your PIN to continue</p>
        </div>
        ...
        <p className="text-center text-[12px] text-white/20 mt-6">🔒 Session ends when you close this tab</p>
      </div>
    </div>
  );
}
